Feature: User Roles
  ...
  Background:
    Given the following user records
      | id | email            | nickname  | roles_mask | password         | password_confirmation | confirmed_at         |
      | 1  | admin@iboard.cc  | admin     | 31         | thisisnotsecret  | thisisnotsecret       | 2010-01-01 00:00:00  |
      | 2  | user@iboard.cc   | testmax   | 27         | thisisnotsecret  | thisisnotsecret       | 2010-01-01 00:00:00  |
      | 3  | guest@iboard.cc  | guest     | 25         | thisisnotsecret  | thisisnotsecret       | 2010-01-01 00:00:00  |
      | 4  | staff@iboard.cc  | staff     | 2          | thisisnotsecret  | thisisnotsecret       | 2010-01-01 00:00:00  |
  ...
  Scenario: Non-admins should not see the edit user page
    Given I sign out
    And I am logged in as user "guest@iboard.cc" with password "thisisnotsecret"
    And I am on edit user page for "user@iboard.cc"
    And I should be on the home page
    And I should see "You are not authorized to access this page"
  ...
  Scenario: Display a list of users when I'm logged in as an admin
    And I am on users page
    Then I should see "admin@iboard.cc"
    And I should see "user@iboard.cc"
  ...
  Scenario: Display a list of users when I'm logged in as a staff member
    ...
    Then I should see "admin@iboard.cc"
    And I should see "user@iboard.cc"
    And I should see "guest@iboard.cc"
    And I should see "staff@iboard.cc"
  ...
  Scenario: Display the user roles mask when I click 'edit user roles'
    ...
    And I should see "admin@iboard.cc"
